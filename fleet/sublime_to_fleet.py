...
class SublimeToFleetConverter:
    ...
    def create_palette_from_variables(
    ...
    def create_colors_from_globals(
        self,
        ...
        # Get resolved colors
        background = self.resolve_color_var(
            globals_dict.get("background", ""), variables
        )
        foreground = self.resolve_color_var(
            globals_dict.get("foreground", ""), variables
        )
        selection = self.resolve_color_var(globals_dict.get("selection", ""), variables)
        line_highlight = self.resolve_color_var(
            globals_dict.get("line_highlight", ""), variables
        )
        caret = self.resolve_color_var(globals_dict.get("caret", ""), variables)

        # Smart palette lookup with fallbacks
        def get_palette_color(
            preferred_names: List[str], fallback: str = "Text"
        ) -> str:
        ...
        colors["editor.whitespace.text"] = get_palette_color(
            ["Comment", "GutterFg", "Text"]
        )
        ...
        # Line numbers
        colors["editor.lineNumber.default"] = get_palette_color(
            ["GutterFg", "Comment", "Text"]
        )
        colors["editor.lineNumber.current"] = get_palette_color(
            ["Keyword", "Purple", "Blue", "Text"]
        )
        ...
        colors["editor.foldIndicator.icon.default"] = get_palette_color(
            ["GutterFg", "Comment"]
        )
        colors["editor.foldIndicator.icon.hovered"] = get_palette_color(
            ["Keyword", "Purple", "Blue"]
        )
        colors["editor.foldIndicator.background.hovered"] = get_palette_color(
            ["Mantle", "Base"]
        )
        colors["editor.interline.background"] = bg  # Terminal/console area background
        colors["editor.interline.match.background"] = get_palette_color(
            ["Yellow", "Orange", "Selection"]
        )
        colors["editor.interline.match.background.secondary"] = get_palette_color(
            ["Yellow", "Orange", "Selection"]
        )
        colors["editor.interline.match.text"] = (
            text_color  # Text color for inline matches like "Git Pull"
        )
        ...
        colors["background.hovered"] = get_palette_color(
            ["LineHighlight", "Selection", "Base"]
        )
        colors["background.selected"] = get_palette_color(
            ["Selection", "LineHighlight", "Base"]
        )
        ...
        # === Borders ===
        colors["border"] = bg
        colors["border.focused"] = get_palette_color(
            ["Keyword", "Purple", "Blue", "Function"]
        )
        ...
        colors["editor.gitDiff.background.added"] = get_palette_color(
            ["DiffInserted", "Green", "String"]
        )
        colors["editor.gitDiff.text.added"] = get_palette_color(
            ["Green", "DiffInserted", "String"]
        )
        colors["editor.gitDiff.background.deleted"] = get_palette_color(
            ["DiffDeleted", "Red", "Operator"]
        )
        colors["editor.gitDiff.text.deleted"] = get_palette_color(
            ["Red", "DiffDeleted", "Operator"]
        )
        colors["editor.gitDiff.background.modified"] = get_palette_color(
            ["DiffModified", "Blue", "Function"]
        )
        colors["editor.gitDiff.text.modified"] = get_palette_color(
            ["Blue", "DiffModified", "Function"]
        )
        colors["editor.gitDiff.background.conflict"] = get_palette_color(
            ["DiffDeleted", "Red", "Operator"]
        )
        colors["editor.gitDiff.text.conflict"] = get_palette_color(
            ["Red", "DiffDeleted", "Operator"]
        )

        # === Links ===
        colors["link.focusOutline"] = get_palette_color(["Blue", "Cyan", "Function"])
        colors["link.text"] = get_palette_color(
            ["Blue", "Cyan", "Function", "Documentation"]
        )

        # === Search & Completion ===
        colors["completion.match.background"] = "Transparent"
        colors["completion.match.text"] = get_palette_color(
            ["Orange", "Yellow", "Constant"]
        )
        colors["search.match.background"] = get_palette_color(
            ["Yellow", "Orange", "Selection"]
        )
        ...
        colors["notification.background.unread"] = get_palette_color(
        ...
        colors["listItem.background.hovered"] = get_palette_color(
            ["LineHighlight", "Selection"]
        )
        colors["listItem.background.focused"] = get_palette_color(
            ["Selection", "LineHighlight"]
        )
        colors["listItem.background.selected"] = get_palette_color(
            ["Selection", "LineHighlight"]
        )
        colors["listItem.background.dnd"] = get_palette_color(
            ["Selection", "LineHighlight"]
        )
        ...
        colors["tree.compactFolder.separator"] = get_palette_color(
            ["Comment", "GutterFg"]
        )
        ...
        colors["tab.background.hovered"] = get_palette_color(
            ["LineHighlight", "Selection"]
        )
        ...
        colors["terminal.ansiColors.background.ansiRed"] = get_palette_color(
            ["Red", "Operator"]
        )
        colors["terminal.ansiColors.foreground.ansiRed"] = get_palette_color(
            ["Red", "Operator"]
        )
        colors["terminal.ansiColors.background.ansiGreen"] = get_palette_color(
            ["Green", "String"]
        )
        colors["terminal.ansiColors.foreground.ansiGreen"] = get_palette_color(
            ["Green", "String"]
        )
        colors["terminal.ansiColors.background.ansiYellow"] = get_palette_color(
            ["Yellow", "Constant"]
        )
        colors["terminal.ansiColors.foreground.ansiYellow"] = get_palette_color(
            ["Yellow", "Constant"]
        )
        colors["terminal.ansiColors.background.ansiBlue"] = get_palette_color(
            ["Blue", "Function"]
        )
        colors["terminal.ansiColors.foreground.ansiBlue"] = get_palette_color(
            ["Blue", "Function"]
        )
        colors["terminal.ansiColors.background.ansiMagenta"] = get_palette_color(
            ["Purple", "Pink", "Keyword"]
        )
        colors["terminal.ansiColors.foreground.ansiMagenta"] = get_palette_color(
            ["Purple", "Pink", "Keyword"]
        )
        colors["terminal.ansiColors.background.ansiCyan"] = get_palette_color(
            ["Cyan", "Blue"]
        )
        colors["terminal.ansiColors.foreground.ansiCyan"] = get_palette_color(
            ["Cyan", "Blue"]
        )
        ...
        colors["terminal.ansiColors.background.ansiBrightBlack"] = get_palette_color(
            ["LineHighlight", "Selection"]
        )
        colors["terminal.ansiColors.foreground.ansiBrightBlack"] = get_palette_color(
            ["Comment", "GutterFg"]
        )
        colors["terminal.ansiColors.background.ansiBrightRed"] = get_palette_color(
            ["Red", "Operator"]
        )
        colors["terminal.ansiColors.foreground.ansiBrightRed"] = get_palette_color(
            ["Red", "Operator"]
        )
        colors["terminal.ansiColors.background.ansiBrightGreen"] = get_palette_color(
            ["Green", "String"]
        )
        colors["terminal.ansiColors.foreground.ansiBrightGreen"] = get_palette_color(
            ["Green", "String"]
        )
        colors["terminal.ansiColors.background.ansiBrightYellow"] = get_palette_color(
            ["Yellow", "Constant"]
        )
        colors["terminal.ansiColors.foreground.ansiBrightYellow"] = get_palette_color(
            ["Yellow", "Constant"]
        )
        colors["terminal.ansiColors.background.ansiBrightBlue"] = get_palette_color(
            ["Blue", "Function"]
        )
        colors["terminal.ansiColors.foreground.ansiBrightBlue"] = get_palette_color(
            ["Blue", "Function"]
        )
        colors["terminal.ansiColors.background.ansiBrightMagenta"] = get_palette_color(
            ["Purple", "Pink", "Keyword"]
        )
        colors["terminal.ansiColors.foreground.ansiBrightMagenta"] = get_palette_color(
            ["Purple", "Pink", "Keyword"]
        )
        colors["terminal.ansiColors.background.ansiBrightCyan"] = get_palette_color(
            ["Cyan", "Blue"]
        )
        colors["terminal.ansiColors.foreground.ansiBrightCyan"] = get_palette_color(
            ["Cyan", "Blue"]
        )
        colors["terminal.ansiColors.background.ansiBrightWhite"] = (
            bg  # Editor background for terminal
        )
        colors["terminal.ansiColors.foreground.ansiBrightWhite"] = text_color

        # === Buttons ===
        # Regular buttons
        colors["button.background.default"] = get_palette_color(
            ["LineHighlight", "Selection"]
        )
        colors["button.background.hovered"] = get_palette_color(
            ["Selection", "LineHighlight"]
        )
        colors["button.text.default"] = text_color
        colors["button.text.hovered"] = text_color
        colors["button.border.default"] = get_palette_color(
            ["Selection", "LineHighlight"]
        )
        ...
        # Secondary buttons
        colors["button.secondary.background.default"] = get_palette_color(
            ["LineHighlight", "Selection"]
        )
        colors["button.secondary.background.hovered"] = get_palette_color(
            ["Selection", "LineHighlight"]
        )
        ...
        colors["button.tile.background.default"] = get_palette_color(
            ["Mantle", "LineHighlight", "Base"]
        )
        colors["button.tile.background.hovered"] = get_palette_color(
            ["LineHighlight", "Selection"]
        )
    ...
    def create_text_attributes(
        ...
        variables: Dict[str, str],
        palette: Dict[str, str],
        globals_dict: Dict[str, str] = None,
    ) -> Dict[str, Dict]:
        ...
        text_attributes["comment.doc.tag"] = {
            "foregroundColor": get_palette_color(
                ["Annotation", "Documentation", "Comment"], "Text"
            )
        }
        ...
        text_attributes["number"] = {
            "foregroundColor": get_palette_color(
                ["Constant", "Orange", "Yellow"], "Text"
            )
        }
        text_attributes["boolean"] = {
            "foregroundColor": get_palette_color(
                ["Keyword", "Purple", "Constant"], "Text"
            )
        }
        ...
        text_attributes["identifier.parameter"] = {
            "foregroundColor": get_palette_color(
                ["Variable", "Text"], "Text"
            )  # Use Variable color instead of Annotation
        }
        ...
        text_attributes["attributeName.html"] = {
            "foregroundColor": get_palette_color(
                ["Annotation", "Yellow", "Function"], "Text"
            )
        }
        ...
        # Markup
        text_attributes["markup.bold"] = {"fontModifier": {"bold": True}}
        text_attributes["markup.italic"] = {"fontModifier": {"italic": True}}
        ...
        if selection_color:
            sel_resolved = find_palette_name(
                self.resolve_color_var(selection_color, variables), "Selection"
            )
        else:
            sel_resolved = get_palette_color(["Selection", "LineHighlight", "Base"])

        if "editor.selection" not in text_attributes:
            text_attributes["editor.selection"] = {"backgroundColor": sel_resolved}
        ...
        selection_color = globals_dict.get("selection", "")
        if selection_color:
            indent_guide_color = find_palette_name(
                self.resolve_color_var(selection_color, variables), "Selection"
            )
        else:
            indent_guide_color = get_palette_color(
                ["Selection", "LineHighlight", "Base"]
            )
        ...
        text_attributes["diff.added"] = {"backgroundColor": added_color}
        text_attributes["diff.added.word"] = {"backgroundColor": added_color}
        text_attributes["diff.deleted"] = {"backgroundColor": deleted_color}
        text_attributes["diff.deleted.word"] = {"backgroundColor": deleted_color}
        text_attributes["diff.modified"] = {"backgroundColor": modified_color}
        text_attributes["diff.modified.word"] = {"backgroundColor": modified_color}
    ...
    def convert(self, sublime_theme: Dict) -> Dict:
        ...
        # Create Fleet theme
        fleet_theme = {
            "meta": {"theme.name": name, "theme.kind": theme_kind, "theme.version": 1},
            "colors": self.create_colors_from_globals(globals_dict, variables, palette),
            "textAttributes": self.create_text_attributes(
                rules, variables, palette, globals_dict
            ),
            "palette": palette,
        }
...
Examples:
  ...
  python3 sublime_to_fleet.py my-theme.sublime-color-scheme my-theme-fleet.json
    ...
    parser.add_argument(
        "input", help="Input Sublime theme file (.sublime-color-scheme or .json)"
    )
